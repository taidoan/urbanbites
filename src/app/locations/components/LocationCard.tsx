      ...
      <CardBody className={style.body}>
        ...
        <div className={style.detailsBlock}>
          ...
          <div className={`${style.subBlock} hours`}>
            ...
            <Divider weight="thin" width="full-width" />
            <span className={style.field}>
              <FontAwesomeIcon icon={faClock} /> Mon-Fri:{" "}
              {location.weekdayHours}
            </span>
            <span className={style.field}>
              <FontAwesomeIcon icon={faClock} />
              Sat-Sun: {location.weekendHours}
            </span>
            <span className={style.field}>
              Serving breakfast until {location.breakfastEnd}
            </span>
            <span className={style.field}>
              Last booking at {location.lastBooking}
            </span>
          </div>
          <div className={`${style.subBlock} ${style.ctaBlock}`}>
            ...
            <Button
              ...
              variant="beige"
              hover="background"
              href={`/bookings?locationId=${location.id}`}
            />
          </div>
        </div>
      </CardBody>
